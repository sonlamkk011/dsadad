...
import { fetchChangeRealEstateStatus } from "../../../service/real-estate-all";
    ...
    return (
        <>
            ...
            <div className="d-flex justify-content-between align-items-center" style={{ margin: "16px 0" }}>
                <Title level={4}>{t("draft-list")}</Title>
                <Breadcrumb>
                    <Breadcrumb.Item>{t("real-estate-manager")}</Breadcrumb.Item>
                    <Breadcrumb.Item>{t("draft-list")}</Breadcrumb.Item>
                </Breadcrumb>
            </div>
...
export default RealEstateDrafts;
